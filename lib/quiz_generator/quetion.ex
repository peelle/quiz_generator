defmodule QuizGenerator.Question do
  ...
  defp generate_multiple_choices( %InputList{} = list, answer, max_choices) do
    ...
    |> Stream.reject(&(answer == &1))
    |> Enum.take_random(max_choices-1) # When enabling options, takes whatever they would specify + 1. ignoring the edge case that they would specify as much as or more more than exits.
